...
## Option 1 (recommended): install R and Rstudio

- Select a mirror to install R: [https://cran.r-project.org/mirrors.html](https://cran.r-project.org/mirrors.html)
- Download the integrated development environment Rstudio here: [https://posit.co/downloads](https://posit.co/downloads)

## Option 2: online container

-   Go to <https://cmgr.oit.duke.edu/containers> and login with your Duke NetID and Password.
-   Click `STA313`(not a typo -- actual container name for fall 2026) to log into the Docker container. You should now see the RStudio environment.

::: callout-warning
If you haven't yet done so, you will need to click "reserve" on a container first.
:::
...
Check if you have a `lab-0` repo here: [https://github.com/sta323-fa26](https://github.com/sta323-fa26). If you do, you are all set. **If not, follow steps 1-2 below.**

1. Fill out [the survey](https://forms.gle/6KWM88hiAKx172hS8) if you did not already and accept the invite to the course organization (check your email).

2. [Click here to create your lab-0 repo](https://classroom.github.com/a/9XUeUL6K)

:::

-   Go to the course organization at [github.com/sta323-fa26](https://github.com/sta323-fa26) organization on GitHub. 
