...
## 3. Extract the body of the email
...
![](img/regexp-img.png){fig-align="center"}
...
- `body`: list containing all lines that comprise the body of the email
...
3. What proportion of emails originate from an academic "edu" sender address? Note: some may be "EDU", e.g. see image above.
