...
Course website: [sta323-fa26.github.io](https://sta323-fa26.github.io/)
...
There will be two in-class exams. Through these exams you have the opportunity to demonstrate what you've learned in the course thus far. Each exam will include exercises related to the content in labs. More details about the content and structure of the exams will be discussed during the semester.

#### Mini project

You and your team will choose from a list of topics to develop a short presentation for lab.

#### Final project

The final project allows you to explore a question and data set of your own choosing. More details about the project will be provided during the semester. Projects will be completed in teams.

#### Quizzes

On pseudo-random class days, there will be a brief quiz on the previous lectures. If you score  $>60\%$ on quizzes, you will receive full participation credit. Your lowest **two** quizzes will also be dropped.
...
Many questions are most effectively answered in-person, so office hours are a valuable resource. Please make use of them. See instructor and TA office hours above.
