...
::: callout-note
## Definition
A regular expression (or regex / regexp) is a tool for identifying patterns in strings.
:::

A regular expression lets you:
...
See [this cheatsheet](https://raw.githubusercontent.com/rstudio/cheatsheets/master/strings.pdf) for a summary of `stringr` functions.
...
```{r}
#| eval: false
download.file("https://sta323-fa25.github.io/data/pirate-phone.txt",
...
```{r}
#| eval: false
download.file("https://sta323-fa25.github.io/data/secret-messages.zip", 
