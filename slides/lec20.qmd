...
-   Final project presentations during class and lab next Tuesday, December 2.
...
-   create 40 repositories named lab07-\[github_team_name\], you'll probably use GitHub's API
...
<!-- ```{r} -->
<!-- #| eval: false -->
<!-- download.file(url = "https://sta323-fa25.github.io/scripts/apiDemo.R", -->
<!--               destfile = "apiDemo.R") -->
<!-- ``` -->
